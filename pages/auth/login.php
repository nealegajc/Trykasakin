        ...
        if (password_verify($password, $user['password'])) {
            ...
            if ($user['status'] != 'active') {
                ...
                if ($user['user_type'] == 'driver') {
                    ...
                    $driver_stmt->close();
                    header("Location: ../driver/loginDriver.php");
                } else {
                    
                    header("Location: ../passenger/loginUser.php");
                }
                exit();
            }
        } else {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="text-center mt-3">
                <p class="mb-2">Don't have an account? <a href="../../pages/auth/register.php" class="text-primary fw-bold">Register here</a></p>
